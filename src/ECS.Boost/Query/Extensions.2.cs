...
{
    public static void For<TEach, T1,T2>(this ArchetypeQuery<T1,T2> query, TEach each)
...
#pragma warning restore CS8500
    ...
    public static void ForEntity<TEachEntity, T1,T2>(this ArchetypeQuery<T1,T2> query, TEachEntity each)
