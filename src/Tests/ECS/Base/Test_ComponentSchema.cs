...
public static class Test_ComponentSchema
{
    ...
    public static void Test_ComponentTypes()
    {
        ...
        AreEqual("components: 75  scripts: 10  entity tags: 17", schema.ToString());
        AreEqual(76,    components.Length);
        AreEqual(11,    scripts.Length);
        
        AreEqual(81,    schema.SchemaTypeByKey.Count);
        AreEqual(75,    schema.ComponentTypeByType.Count);
