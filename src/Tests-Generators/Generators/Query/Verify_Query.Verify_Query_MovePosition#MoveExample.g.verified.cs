...
namespace VerifyQuery
{
    ...
    #region private members
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        private static ArchetypeQuery<global::Friflo.Engine.ECS.Position> _MoveExample_GetQuery(EntityStore _store)
        {
            var _query = (ArchetypeQuery<global::Friflo.Engine.ECS.Position>)EntityStore.UserDataGet(_store, _MoveExample_Slot);
            if (_query != null) {
                return _query;
            }
