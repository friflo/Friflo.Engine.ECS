...
namespace Tests.Generators.Vectorize
{
    public partial class Test_Locals_Avx
    {
        ...
        public static ArchetypeQuery EmptyBodyQuery(EntityStore _store, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _EmptyBody_Avx(positionSpan, velocitySpan);
                }
            EntityLoop:
                for (; n < _entities.Length; n++) {
                    EmptyBody(ref positionSpan[n], in velocitySpan[n]);
                }
            }
            return _query;
        }
