...
#region will be generated
    ...
    public static ArchetypeQuery MovePositionQuery(EntityStore store, bool vectorize)
    {
...
public static class Test_Query_Lab
{
    ...
    public static void Test_SrcGen_Call() {
        ...
        TestClass.MovePositionQuery(store, false);
    ...
    public static void Test_SrcGen_Call_Avx() {
        ...
        TestClass.MovePositionQuery(store, true);
        for (int i = 0; i < 100; i++) {
