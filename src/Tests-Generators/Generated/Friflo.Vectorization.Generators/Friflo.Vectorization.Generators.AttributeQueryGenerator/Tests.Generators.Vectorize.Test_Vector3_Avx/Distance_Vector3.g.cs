    ...
    public partial class Test_Vector3_Avx
    {
        ...
        public static ArchetypeQuery Distance_Vector3Query(EntityStore _store, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _Distance_Vector3_Avx(positionSpan, velocitySpan, lengthSpan);
                }
            EntityLoop:
                for (; n < _entities.Length; n++) {
                    Distance_Vector3(positionSpan[n], velocitySpan[n], ref lengthSpan[n]);
                }
            }
            return _query;
        }
            ...
            Span<global::Tests.ECS.FloatComponent> length)
        {
            ...
            fixed (global::Tests.ECS.FloatComponent* length_first = length)
            {
                for (; i <= end; i += 8)
                {
                    ...
                    length_0 = AvxVector3.Distance(temp0_0,temp0_1,temp0_2, temp1_0,temp1_1,temp1_2);
