...
///   for collection.
/// </remarks>
internal sealed class StructAoSVector2<T> : StructHeap<T>
    where T : struct
{
    private const   int     FieldCount = 2;
    private const   int     Shift      = 1; // * 2
    ...
    internal StructAoSVector2(int structIndex)
        : base (structIndex)
    {
    ...
    {
        var targetSoA       = (StructAoSVector2<T>)targetHeap;
