...
public static partial class Test_Vector3_Avx
{
    ...
    // -----------------------------------------------------------------------------------------------------
    [Vectorize][Query]  [OmitHash]
    private static void Distance_Vector3(Position position, Velocity velocity, ref FloatComponent length)
    {
        length.value = Vector3.Distance(position.value, velocity.value);
    }

    [Test]
    public static void Test_Distance_Vector3()
    {
        var store = CreateTestStore();
        Distance_Vector3Query(store, false);

        var storeVectorized = CreateTestStore();
        var query = Distance_Vector3Query(storeVectorized);
    ...
    // -----------------------------------------------------------------------------------------------------
    [Vectorize][Query]  [OmitHash]
    private static void DistanceSquared_Vector3(Position position, Velocity velocity, ref FloatComponent length)
    {
        length.value = Vector3.DistanceSquared(position.value, velocity.value);
    }

    [Test]
    public static void Test_DistanceSquared_Vector3()
    {
        var store = CreateTestStore();
        DistanceSquared_Vector3Query(store, false);
