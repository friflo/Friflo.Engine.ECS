...
namespace Tests.Generators.Vectorize
{
    public partial class Test_Vector4_Avx
    {
        ...
        public static ArchetypeQuery Normalize_Vector4Query(EntityStore _store, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _Normalize_Vector4_Avx(positionSpan, velocitySpan);
                }
            EntityLoop:
    ...
    #region private members
        ...
        [SkipLocalsInit]
        private static unsafe int _Normalize_Vector4_Avx(
