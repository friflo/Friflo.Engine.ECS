...
public static class Test_ComponentSchema
{
    ...
    public static void Test_ComponentTypes()
    {
        ...
        AreEqual("components: 74  scripts: 10  entity tags: 17", schema.ToString());
        AreEqual(75,    components.Length);
        AreEqual(11,    scripts.Length);
        
        AreEqual(80,    schema.SchemaTypeByKey.Count);
        AreEqual(74,    schema.ComponentTypeByType.Count);
