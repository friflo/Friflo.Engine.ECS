...
#region will be generated
    ...
    /// <summary>
    /// Query method generated by <see cref="MovePosition"/>. 
    /// </summary>
    public static ArchetypeQuery MovePositionQuery_Example(EntityStore store)
    {
...
public static class Test_SrcGen
{
    ...
    public static void Test_SrcGen_Call() {
        ...
        TestClass.MovePositionQuery_Example(store);
