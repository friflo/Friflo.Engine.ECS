...
where T5 : struct
{
    ...
    SetChunks:
        ...
        var chunk2      = new Chunk<T2>(chunks2.GetComponents(), count, start);
        var chunk3      = new Chunk<T3>(chunks3.GetComponents(), count, start);
        var chunk4      = new Chunk<T4>(chunks4.GetComponents(), count, start);
        var chunk5      = new Chunk<T5>(chunks5.GetComponents(), count, start);
