...
namespace Tests.Generators.Vectorize
{
    public partial class Test_Vector4_Avx
    {
        ...
        public static ArchetypeQuery MultiplyVectorQuery(EntityStore _store, global::System.Numerics.Vector4 vector4, bool vectorized = true)
        {
            ...
            foreach (var chunk in _query.Chunks)
            {
                ...
                if (Avx.IsSupported) {
                    n = _MultiplyVector_Avx(positionSpan, velocitySpan, vector4);
                }
            EntityLoop:
                for (; n < _entities.Length; n++) {
                    MultiplyVector(ref positionSpan[n], in velocitySpan[n], vector4);
                }
            }
            return _query;
        }
